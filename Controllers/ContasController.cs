...
namespace Dinheiro.Controllers
{
	public class ContasController : Controller
	{
		...
		public async Task<IActionResult> Create([Bind("Id,Nome,SaldoInicial,Tipo")] Conta conta)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,SaldoInicial,Tipo")] Conta conta)
		{
			if (id != conta.Id)
			{
				return NotFound();
